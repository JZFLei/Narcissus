...
let calculateColourDelta = function(input1, input2, position1, position2) {
  ...
  let percievedLuminance =
    rgb2y(red1, green1, blue1) - rgb2y(red2, green2, blue2);
  let colourInformation =
    rgb2i(red1, green1, blue1) - rgb2i(red2, green2, blue2);
  let luminanceInformation =
    rgb2q(red1, green1, blue1) - rgb2q(red2, green2, blue2);

  return (
    0.5053 * percievedLuminance * percievedLuminance +
    0.299 * colourInformation * colourInformation +
    0.1957 * luminanceInformation * luminanceInformation
  );
};
...
let rgb2i = function(red, green, blue) {
  return red * 0.59597799 - green * 0.2741761 - blue * 0.32180189;
};
